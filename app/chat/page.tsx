  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-background">
      <div className="flex flex-col items-center justify-center max-w-md p-6 text-center animate-in fade-in zoom-in duration-500">
        <div className="w-14 h-14 bg-primary/10 rounded-lg flex items-center justify-center mb-6 border border-primary/20 shadow-sm">
          <FiMessageCircle className="w-7 h-7 text-primary" />
        </div>
        <h2 className="text-xl font-bold text-foreground mb-2">Welcome to DocsChat.ai</h2>
        ...
        <div className="grid grid-cols-2 gap-4 w-full max-w-xs">
          <div className="flex flex-col items-center gap-2.5 p-4 rounded-lg border border-border bg-card hover:bg-muted/50 hover:border-primary/25 transition-all duration-200 shadow-xs">
